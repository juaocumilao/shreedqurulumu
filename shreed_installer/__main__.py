...
def createApp (connect):
    appname = "shreed" + str(time() * 1000)[-4:].replace(".", "") + str(random.randint(0,500))
    try:
...
if __name__ == "__main__":
    ...
    if os.path.isdir("./ShreedUserBot/"):
        rm_r("./ShreedUserBot/")
    repo = Repo.clone_from(str1,"./ShreedUserBot/", branch="main")
    ...
    config['DEFAULT_BIO'] = "@ShreedUserBot"
    ...
    config['TZ'] = TZ
    config['TZ_NUMBER'] = "1"
    config['UPSTREAM_REPO_URL'] = "https://github.com/ShreedUserBot/ShreedUserBot"
    config['WARN_LIMIT'] = "3"
